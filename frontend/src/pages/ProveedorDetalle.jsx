...
export default function ProveedorDetalle() {
  ...
  async function handleHistorico(doc) {
    const result = await Swal.fire({
      ...
      html: `<span style="word-break:break-word">"<strong>${doc.nombre_original}</strong>" saldrá de este proveedor y quedará en el archivo histórico del sistema.</span>`,
      icon: 'question',
      showCancelButton: true,
      confirmButtonColor: '#E8621A',
    ...
    try {
      await api.post('/historicos', { tipo: 'proveedor', doc_id: doc.id });
      setProveedor(prev => ({
        ...prev,
