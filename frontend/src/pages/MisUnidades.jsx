...
function BadgeEstado({ estado }) {
  ...
  const texto = { pendiente: 'En revisión', aprobado: 'Aprobado', desaprobado: 'Rechazado' };
...
export default function MisUnidades() {
  ...
  async function cargarDatos() {
    ...
    try {
      ...
      Swal.fire({ icon: 'error', title: 'Error', text: 'No se pudo cargar tu unidad.', confirmButtonColor: '#E8621A' });
    } finally {
      setCargando(false);
    }
  }
  ...
  async function handleSeleccionArchivo(e) {
    ...
    try {
      ...
      const res = await api.post(`/unidades/${unidad.id}/documentos`, formData, {
  ...
  async function handleDescargar(doc) {
    try {
      const res = await api.get(`/unidades/documentos/${doc.id}/descargar`, { responseType: 'blob' });
    ...
    <div className={styles.pagina}>
      ...
      <header className={styles.header}>
        <div className={styles.marca}>
          ...
          <span className={styles.appNombre}>Portal de Unidades</span>
        </div>
          ...
          <>
            ...
            <div className={styles.perfilCard}>
              ...
              <div className={styles.perfilInfo}>
                <h1 className={styles.perfilNombre}>{unidad?.nombre}</h1>
                <p className={styles.perfilRfc}>Cocina / Sucursal</p>
              </div>
            ...
            <div className={styles.seccionDocs}>
              <h2 className={styles.seccionTitulo}>Documentos de la unidad ({docs.length})</h2>
